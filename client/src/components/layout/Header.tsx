      ...
      <div className="container mx-auto px-4 flex justify-between items-center">
        ...
        <nav>
          <ul className="flex space-x-6">
            <li>
              <Link href="/">
                <div className={`${location === '/' ? 'text-primary font-medium' : 'text-gray-600 font-medium hover:text-primary'} transition-colors cursor-pointer`}>
                  Discover
                </div>
              </Link>
            </li>
            <li>
              <Link href="/saved-recipes">
                <div className={`${location === '/saved-recipes' ? 'text-primary font-medium' : 'text-gray-600 font-medium hover:text-primary'} transition-colors cursor-pointer`}>
                  Saved Recipes
                </div>
              </Link>
            </li>
            <li>
              <Link href="/chat">
                <div className={`${location === '/chat' ? 'text-primary font-medium' : 'text-gray-600 font-medium hover:text-primary'} transition-colors flex items-center cursor-pointer`}>
